...
/*
 * Collects a user value betw21een 1 and the number of students in your class inclusive and prints 
...
public class Main
{
   ...
   * 
   * @param studentNumber Precondition: studentNumber is an int between 1 and 21 inclusive
   * @return the student name corresponding to studentNumber
   */
  public static String getStudent(int studentNumber)
  {
    String students = ("AA PC OC AD SG KH RH MH AL RL JS FS ES AS ASt RS BT AW JW SW MY ");
  ...
  public static String getInput()
  {
    ...
    // with value between 1 and 21 inclusive.
